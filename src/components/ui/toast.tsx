...
const toastVariants = cva(
  "group pointer-events-auto relative flex w-full items-start justify-between gap-3 overflow-hidden rounded-xl border p-4 pr-8 shadow-card-lg transition-all data-[state=open]:animate-fade-in-up data-[state=closed]:animate-fade-in data-[swipe=end]:animate-slide-in-right",
  {
    variants: {
      variant: {
